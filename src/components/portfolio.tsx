        ...
        <div className="row no-gutters">
          <div className="col-lg-4 col-sm-6">
            <div className="portfolio-box cus-thumb">
              ...
              <div className={`portfolio-box-caption ${visibility ? 'opacity-on delay-0' : ''}`}>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="portfolio-box cus-thumb">
              ...
              <div className={`portfolio-box-caption ${visibility ? 'opacity-on delay-1' : ''}`}>
                <div className="project-category text-white-50">LG Electronics</div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="portfolio-box cus-thumb">
              ...
              <div className={`portfolio-box-caption ${visibility ? 'opacity-on delay-2' : ''}`}>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="portfolio-box cus-thumb">
              ...
              <div className={`portfolio-box-caption ${visibility ? 'opacity-on delay-3' : ''}`}>
                <div className="project-category text-white-50">SK Planet</div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="portfolio-box cus-thumb">
              ...
              <div className={`portfolio-box-caption ${visibility ? 'opacity-on delay-4' : ''}`}>
                <div className="project-category text-white-50">SK Planet</div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="portfolio-box cus-thumb">
              ...
              <div className={`portfolio-box-caption ${visibility ? 'opacity-on delay-5' : ''}`}>
                <div className="project-category text-white-50">SK Planet</div>
